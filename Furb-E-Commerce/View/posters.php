...
<html>
<head>
	<title>E-Commerce Maneiro | Posters</title>
   ...
   <div id="itemImage" class="item-image" style="padding-top: 5%"> 
        <div class="row">
	       	<div id="produtoDestaque" class="col-sm-4">
	       		<div id="itemDestaqueToHover">
		        	<div id="itemDestaque"  class="item-image">
		          		<img src="..\imagens\poster1.jpg" class="img-responsive">
		        	</div>
 	       	...
 	       	<div  class="col-sm-4">
 	       		<div id="itemDestaqueToHover">
		        	<div id="itemDestaque" class="item-image">
		          		<img src="..\imagens\poster2.jpg" class="img-responsive">
		        	</div>
		        	<div class="item-content">
		          		<div class="item-text product-price" >
	      	...
	      	<div  class="col-sm-4">
 	       		<div id="itemDestaqueToHover">
		        	<div id="itemDestaque" class="item-image">
		          		<img src="..\imagens\poster3.jpg" class="img-responsive">
		        	</div>
		        	<div class="item-content">
		          		<div class="item-text product-price" >
