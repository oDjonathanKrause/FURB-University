 ...
 * and must not be reproduced in any form. Employee class- to be used as key in
 * HashMapCustom.
 */
class Employee
{
 ...
 * implementation of HashMap(without using java api's)- which allows us to store
 * data in key-value pair form. insertion order of key-value pairs is not
 * maintained.
 * @param <K>
 * @param <V>
 */
class HashMapCustom<K, V>
{
     ...
     * does not allows you to put null key thought it allows null values.
