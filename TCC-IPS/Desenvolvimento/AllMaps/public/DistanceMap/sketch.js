...
function setup() {
  ...
  createCanvas(800, 400) //createCanvas(480, 858)
...
function updateBeacons() {
    ...
    if (!isEmptyQueueObj.isEmpty) {
      ...
      beacon.dist = d
      receiver.pos.x = map(beacon.dist, 0, 100, 50, width-50)
    }
...
function initBeacons() {
  lemonBeacon = new Beacon('D7:80:45:7D:C8:86', createVector(50, height/2), LEMON_COLOR, 'beacon_amarelo', -78)
